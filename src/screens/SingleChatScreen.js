...
export default class Chat extends React.Component {
                ...
                <View style={styles.body}>
                    ...
                    <View style={styles.message_box}>
                        <TextInput
                            ...
                            multiline={true}
                            onChangeText={this._updateMessage}
                            value={this.message}
    ...
    _renderItem = ({ item }) => {
        ...
        <View key={item.key} style={styles.msg}>
            ...
            <View style={styles.username}>
                <Text 
                    style={[styles.username_text, styles[username_style]]}
                    onPress={() => this._checkDetailInfo()}>
                        {item.username}
                </Text>
            </View>
    ...
    _sendMessage= () => {
        console.log("SingleChatScreen.js _sendMessage. user click the send button");
    }
    _checkDetailInfo = () => {
        console.log("SingleChatScreen.js _checkDetailInfo. goto PersonDetailScreen");
